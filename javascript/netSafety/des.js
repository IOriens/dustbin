...
var key = "0x30 0x30 0x30 0x30 0x30 0x30 0x30 0x30";
var message = "0x31 0x31 0x31 0x31 0x31 0x31 0x31 0x31";
var ciphertext = des(key, message, 1, 0);
var hex = stringToHex(ciphertext)
console.log("Enc: " + hex);
console.log("Dec: " + hexToString(hex))